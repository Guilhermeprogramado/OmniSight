...
export const metadata: Metadata = {
  title: "Privacy Policy | OmniSight",
  description:
    "Privacy Policy and data handling practices for OmniSight services.",
  openGraph: {
    title: "Privacy Policy | OmniSight",
    description:
      "Privacy Policy and data handling practices for OmniSight services.",
    ...
    <div className="px-4 py-8 pb-16 md:px-0">
      <div className="container mx-auto max-w-2xl space-y-6 rounded-md border bg-card px-4 py-8 shadow-lg sm:px-8">
        <h1 className="mb-5 text-center text-3xl font-semibold text-card-foreground">
          OmniSight Privacy Policy
        </h1>

        <div className="mt-4 text-lg leading-relaxed text-card-foreground">
          <p className="mb-6">
            Welcome to OmniSight. This Privacy Policy explains how OmniSight LLC
          ...
          <ul className="list-inside list-decimal">
            ...
            <li className="mb-3">
              ...
              individuals outside of OmniSight LLC except in the following
              circumstances:
