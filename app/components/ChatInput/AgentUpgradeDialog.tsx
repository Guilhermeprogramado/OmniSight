            ...
            {isFreeUser
              ...
              : isDesktopEnvironment
                ? desktopBridgeStatus === "failed"
                  ? "OmniSight Desktop is open, but its local sandbox could not connect."
                  : desktopBridgeStatus === "connected"
                    ? "OmniSight Desktop is connected and ready for local Agent mode."
                    : "OmniSight Desktop is connecting its local sandbox."
