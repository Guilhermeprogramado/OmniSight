    ...
    <Popover open={open} onOpenChange={handleOpenChange}>
      <PopoverTrigger asChild>
        <Button
          ...
          aria-label="Set up OmniSight Desktop for Agent mode"
          title="Set up OmniSight Desktop"
        ...
        <div className="space-y-3 p-3">
          ...
          {isMobilePlatform ? (
            <p className="text-xs text-muted-foreground">
              ...
              <span translate="no">OmniSight Desktop</span> for macOS, Windows,
              or Linux.
            </p>
          ) : (
            <Button asChild size="sm" className="w-full">
              ...
              >
                Download <span translate="no">OmniSight Desktop</span>
              </a>
            </Button>
          )}
        </div>
