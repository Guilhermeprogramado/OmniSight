...
const FILE_APPROVAL_TITLES: Partial<Record<FileInput["action"], string>> = {
  write: "Allow OmniSight to create this file?",
  append: "Allow OmniSight to append to this file?",
  edit: "Allow OmniSight to edit this file?",
};
  ...
  const renderApprovalRequest = ({
    ...
    <ToolApprovalControls
      ...
      title={
        ...
        "Allow OmniSight to change this file?"
      }
      target={target}
