...
export const DeleteAccountDialog = ({
  ...
  const phraseMatches = useMemo(() => {
    ...
    return normalized === "delete" || normalized === "excluir";
  }, [confirmInput]);
          ...
          <div className="pt-4 space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="delete-confirm">
                To proceed, type &quot;DELETE&quot; or &quot;EXCLUIR&quot; in the
                input field below.
              </Label>
              <Input
                data-testid="delete-phrase-input"
                id="delete-confirm"
                aria-label="Type DELETE or EXCLUIR to confirm"
                placeholder="DELETE / EXCLUIR"
                value={confirmInput}
                onChange={(e) => setConfirmInput(e.target.value)}
                aria-invalid={Boolean(confirmInput) && !phraseMatches}
              />
            </div>
          </div>
        )}
