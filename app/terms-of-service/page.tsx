...
export const metadata: Metadata = {
  title: "Terms of Service | OmniSight",
  description: "Terms of Service and conditions for OmniSight services.",
  openGraph: {
    title: "Terms of Service | OmniSight",
    description: "Terms of Service and conditions for OmniSight services.",
    type: "website",
        ...
        <div className="mt-4 text-lg leading-relaxed text-card-foreground">
          <ol className="list-inside list-decimal">
            ...
            <li className="mb-3">
              ...
              harmless OmniSight LLC, its parent companies, and their respective
            ...
            <li className="mb-3">
              <strong>Changes to Terms of Service:</strong> OmniSight LLC
          ...
          <p className="mt-4">
            By using the Products provided by OmniSight LLC, you indicate your
