  ...
  test("prepares fixed aliases and architecture-specific updater entries", () => {
    ...
    try {
      ...
      expect(latest.platforms["darwin-aarch64"]).toEqual({
        url: "https://github.com/hackerai-tech/hackerai/releases/download/desktop-v0.0.57/OmniSight-aarch64.app.tar.gz",
        signature: signatureFor("mac-arm-updater"),
      });
      expect(latest.platforms["darwin-x86_64"]).toEqual({
        url: "https://github.com/hackerai-tech/hackerai/releases/download/desktop-v0.0.57/OmniSight-x86_64.app.tar.gz",
