...
const APPROVAL_PROTOCOL_DENIED_REASON =
  "This approval response is incompatible with the current Agent worker. The operation was not run. Refresh OmniSight and start a new Agent request.";
            ...
            try {
              ...
              if (
                ...
                autoReviewDecision = {
                  ...
                  rationale:
                    "OmniSight could not verify the current authorization context automatically.",
                  source: "failure",
  ...
  run: async (payload: AgentLongPayload, { ctx, signal: triggerSignal }) => {
    ...
    if (
      ...
      throw new ChatSDKError(
        "bad_request:api",
        "This Agent approval request uses an unsupported protocol version. Refresh OmniSight and start a new Agent request.",
      );
    }
