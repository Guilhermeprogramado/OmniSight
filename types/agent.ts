...
export const getAgentToolApprovalPromptTitle = ({
  ...
  if (operation === "terminal_execute") {
    return "Allow OmniSight to run this terminal command?";
  }
  if (operation === "terminal_interact") {
    return "Allow OmniSight to interact with this terminal session?";
  }
  if (operation === "file_write") {
    return "Allow OmniSight to create this file?";
  }
  if (operation === "file_append") {
    return "Allow OmniSight to append to this file?";
  }
  if (operation === "file_edit") {
    return "Allow OmniSight to edit this file?";
  }
  return fallback;
};
