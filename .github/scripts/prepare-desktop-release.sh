...
copy_one "$ARTIFACTS_DIR/desktop-macOS-arm64" "OmniSight_${VERSION}_aarch64.dmg"
copy_one "$ARTIFACTS_DIR/desktop-macOS-x64" "OmniSight_${VERSION}_x64.dmg"
copy_one "$ARTIFACTS_DIR/desktop-macOS-universal" "OmniSight-universal.dmg"
copy_one "$ARTIFACTS_DIR/desktop-Linux-x64" "OmniSight_${VERSION}_amd64.AppImage"
copy_one "$ARTIFACTS_DIR/desktop-Linux-x64" "OmniSight_${VERSION}_amd64.AppImage.tar.gz"
copy_one "$ARTIFACTS_DIR/desktop-Linux-x64" "OmniSight_${VERSION}_amd64.AppImage.tar.gz.sig"
copy_one "$ARTIFACTS_DIR/desktop-Linux-x64" "OmniSight_${VERSION}_amd64.deb"
copy_one "$ARTIFACTS_DIR/desktop-Linux-arm64" "OmniSight_${VERSION}_aarch64.AppImage"
copy_one "$ARTIFACTS_DIR/desktop-Linux-arm64" "OmniSight_${VERSION}_aarch64.AppImage.tar.gz"
copy_one "$ARTIFACTS_DIR/desktop-Linux-arm64" "OmniSight_${VERSION}_aarch64.AppImage.tar.gz.sig"
copy_one "$ARTIFACTS_DIR/desktop-Linux-arm64" "OmniSight_${VERSION}_arm64.deb"
copy_one "$ARTIFACTS_DIR/desktop-Windows-x64" "OmniSight_${VERSION}_x64-setup.exe"
copy_one "$ARTIFACTS_DIR/desktop-Windows-x64" "OmniSight_${VERSION}_x64-setup.nsis.zip"
copy_one "$ARTIFACTS_DIR/desktop-Windows-x64" "OmniSight_${VERSION}_x64-setup.nsis.zip.sig"
...
copy_one "$ARTIFACTS_DIR/desktop-macOS-arm64" "OmniSight.app.tar.gz" "OmniSight-aarch64.app.tar.gz"
copy_one "$ARTIFACTS_DIR/desktop-macOS-arm64" "OmniSight.app.tar.gz.sig" "OmniSight-aarch64.app.tar.gz.sig"
copy_one "$ARTIFACTS_DIR/desktop-macOS-x64" "OmniSight.app.tar.gz" "OmniSight-x86_64.app.tar.gz"
copy_one "$ARTIFACTS_DIR/desktop-macOS-x64" "OmniSight.app.tar.gz.sig" "OmniSight-x86_64.app.tar.gz.sig"

cp "$RELEASE_DIR/OmniSight_${VERSION}_amd64.AppImage" "$RELEASE_DIR/OmniSight-linux-x64.AppImage"
cp "$RELEASE_DIR/OmniSight_${VERSION}_aarch64.AppImage" "$RELEASE_DIR/OmniSight-linux-arm64.AppImage"
cp "$RELEASE_DIR/OmniSight_${VERSION}_amd64.deb" "$RELEASE_DIR/OmniSight-linux-x64.deb"
cp "$RELEASE_DIR/OmniSight_${VERSION}_arm64.deb" "$RELEASE_DIR/OmniSight-linux-arm64.deb"
cp "$RELEASE_DIR/OmniSight_${VERSION}_x64-setup.exe" "$RELEASE_DIR/OmniSight-windows-x64.exe"
...
MACOS_ARM_FILE="OmniSight-aarch64.app.tar.gz"
MACOS_X64_FILE="OmniSight-x86_64.app.tar.gz"
LINUX_X64_FILE="OmniSight_${VERSION}_amd64.AppImage.tar.gz"
LINUX_ARM_FILE="OmniSight_${VERSION}_aarch64.AppImage.tar.gz"
WINDOWS_FILE="OmniSight_${VERSION}_x64-setup.nsis.zip"
