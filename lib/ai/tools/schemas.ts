...
export const toolBriefSchema = z
  ...
  .optional()
  .describe(
    "Optional display metadata. Include a concise one-sentence preamble whenever possible so the user understands the operation; if omitted, OmniSight will show a generated fallback label.",
  );
      ...
      ...(approvalGated
        ? {
            justification: z
              ...
              .optional()
              .describe(
                "A concise, user-facing reason shown in OmniSight's approval prompt. Explain the intended outcome rather than repeating the command.",
              ),
            prefix_rule: z
