...
// All inference runs on free OpenRouter model slugs. Subscription revenue
// covers tool access, so no token usage ever costs points.
...
const MODEL_PRICING_MAP: Record<string, ModelPricing> = {
  ...
  // Free tier routes run on the free Nemotron slug; they cost no credits.
  "ask-model-free": FREE_MODEL_PRICING,
  "agent-model-free": FREE_MODEL_PRICING,
  "title-generator-model": FREE_MODEL_PRICING,
  "model-glm-5.2-free": FREE_MODEL_PRICING,
  "agent-auto-review-model": FREE_MODEL_PRICING,
  "nvidia/nemotron-3-super-120b-a12b:free": FREE_MODEL_PRICING,
  "nvidia/nemotron-3-super-120b-a12b": FREE_MODEL_PRICING,
  "z-ai/glm-5.2:free": FREE_MODEL_PRICING,
...
/**
 * Estimate raw model spend without applying OmniSight's billing multiplier.
 *
