...
OmniSight Local Sandbox Client - Execute commands on your local machine from OmniSight.
...
Commands run directly on your host OS. The client connects to OmniSight and relays commands in real-time.

## Options

| Option             | Description                                            |
| ------------------ | ------------------------------------------------------ |
| `--token TOKEN`    | Authentication token from OmniSight Settings (required) |
...
1. Go to [OmniSight Settings](https://hackerai.co/settings)
