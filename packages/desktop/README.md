...
Native desktop application for OmniSight built with [Tauri](https://tauri.app/).

## Overview

The desktop app wraps the OmniSight web application in a native shell, providing:
